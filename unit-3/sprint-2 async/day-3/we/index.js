//https://api.openweathermap.org/data/2.5/weather?q=Nagpur&appid=997773fad909098cbbbd785f929eacaf

//api_key==> "997773fad909098cbbbd785f929eacaf"


function getData(){
    let city = document.getElementById("query").value;

    let url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=997773fad909098cbbbd785f929eacaf`
